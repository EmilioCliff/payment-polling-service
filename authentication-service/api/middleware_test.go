...
func addAuthorization(t *testing.T, req *http.Request, tokenMaker utils.JWTMaker, authorizationType string, username string, duration time.Duration) {
...
func TestAuthenticationMiddleware(t *testing.T) {
	testCases := []struct {
		name             string
		setAuthorization func(req *http.Request, t *testing.T, tokenMaker utils.JWTMaker)
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			testServer := newServerTest(t, nil)
